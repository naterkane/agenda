 ...
 * @param {function} cb i.e. callback function
 ...
 *  @param {string} collection collection name or undefined for default 'agendaJobs'
 ...
 *  @param {object} query Raw MoggoDB query object, the same you'd pass to `Mongo.collection.find()`
 *  @param {function} cb callback function
 */
 ...
 * @param {Object} agenda metadata representing the job
